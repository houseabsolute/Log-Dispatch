...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends Log::Dispatch
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Log::Dispatch
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Log-Dispatch).
